...
-- Usamos INSERT explícito de PK para garantir que os FK do DER batam com os IDs do seed.
...
-- Também fixamos a PK para que FK_id_equipamento nos inserts dependentes seja válido.
